  ...
  <div style="padding: 30px;">
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <span style="font-size: 16px">客户转账</span>
      </div>
      <div class="contend">
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form id="form" ref="transferFormRef" :model="transferForm" :rules="FormRules" class="demo-ruleForm"
              ...
              <el-form-item label="付款银行卡号" prop="paymentAccount">
                <el-input v-model="transferForm.paymentAccount" />
              </el-form-item>
              ...
              <el-form-item label="转账金额" prop="transferAmount">
                <el-row>
                  ...
                  <el-col :span="6" style="margin-left:10px;width:120px">
                    <span style="font-size:15px;color:grey">手续费：{{ transferForm.handingFee}} 元</span>
                  </el-col>
                </el-row>
              </el-form-item>
